...
describe('getEnvironment', () => {
    it('Should return int/qa/stage/prod environment', () => {
        environment = [getEnvironment('int/'), getEnvironment('qa/'), getEnvironment('stage/'), getEnvironment('prod/')]
...
describe('getVersionObject', () => {
    it('Should return correct version', () => {
        version = getVersionObject('/1.2.3/')
...
describe('getLatestVersion', () => {
    ...
    it('Should find specific version', async () => {
        const mockListObjectV2 = jest.fn((bucketParams, callback) => {
            callback(undefined, {
                Contents: [{Key: 'int/2.0.1'}, {Key: 'int/1.1.2'}, {Key: 'int/1.1.1'}]
            })
        })
